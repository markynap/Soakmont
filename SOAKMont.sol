...
contract SOAKMont is IERC20, Ownable {
    ...
    // token data
    string private constant _name = "SOAKMONT";
    string private constant _symbol = "SOAKMONT";
    ...
    constructor() {
        ...
        MAX_TOTAL_SUPPLY = 10**11 * 10**_decimals;
    ...
    function _mint(address account, uint256 amount) internal returns (bool) {
        ...
        _balances[account] = _balances[account].add(amount, 'Balance Underflow');
        _totalSupply = _totalSupply.add(amount, 'Supply Underflow');
